...
saveGitHubFile(f"workspace-service/{WORKSPACE_COMMIT_SHA}/src/rest/api/hidden/parameters/orgs.yaml", f"./internal/workspace/{WORKSPACE_API_VERSION}/parameters/orgs.yaml")
